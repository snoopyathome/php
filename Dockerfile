...
RUN apk add --update-cache --repository http://dl-cdn.alpinelinux.org/alpine/edge/community/ php7 php7-session php7-pecl-redis php7-pecl-apcu php7-gettext php7-fpm php7-mbstring php7-ctype php7-dom php7-gd php7-iconv php7-json php7-xml php7-xmlreader php7-xmlwriter php7-posix php7-zlib php7-zip php7-curl php7-fileinfo php7-opcache php7-openssl php7-mcrypt php7-ldap php7-intl php7-pdo_mysql php7-mysqli php7-mysqlnd php7-simplexml php7-imagick php7-exif php7-pcntl php7-gmp php7-ftp php7-bcmath php7-phar gnu-libiconv &&\
